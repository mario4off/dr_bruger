<div class="container">
    ...
    <div class="d-none-block d-md-flex justify-content-center gap-5 mb-4">
        ...
        <?php include_once(path_base . 'app/views/partials/data_checkout.php') ?>
        <section
            class="col-5 cart p-3 pt-0 pb-2 pt-4 mt-4 mb-4 checkout-box d-flex flex-column justify-content-between">
            <?php if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0) {
                ...
                <div class="h-100 d-flex align-items-center flex-column justify-content-center">
                    <h2 class="mb-2 fs-2">EL CARRITO ESTÁ VACÍO</h2>
