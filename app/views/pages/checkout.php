<div class="container">
 ...
 En caso contrario se carga el módulo con los datos para realizar el pedido -->
        ...
        <section
            class="col-12 col-md-5 cart p-4 checkout-box d-flex flex-column justify-content-between">
            ...
            ?>
                <div class="h-100 d-flex align-items-center flex-column justify-content-center">
                    ...
                    <a class="snd-btn-1 " href="?controller=product&action=showMenu">VER PRODUCTOS</a>
                </div>
            <?php
